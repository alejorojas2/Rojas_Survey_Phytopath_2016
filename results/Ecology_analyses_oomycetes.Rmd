...
## Rarefaction curves
```{r rarefaction_curvers, warning=FALSE}
## DATA ##
...
```{r var_plots, warning=FALSE, message=FALSE, fig.height=10}
library(ggradar)
library(scales)
library(MASS)
